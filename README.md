...
Este projeto tem por objetivo colocar em prática alguns conceitos de Aprendizado Supervisionado, abordados na disciplina de Aprendizado de Máquina.
Para informações detalhadas, consulte os arquivos "descricao.pdf" e "relatorio.pdf".
